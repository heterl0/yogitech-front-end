  ...
  return (
    <MainLayout>
      <div className="flex flex-col">
        {/* Hero Section */}
        <div className="bg-white-main relative min-h-[calc(100vh-100px)] w-full">
          <Image
          ...
          <div className="relative z-20 mx-auto flex min-h-screen max-w-7xl flex-col justify-end gap-4 px-4 py-24">
